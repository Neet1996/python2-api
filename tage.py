...
def bot(op):
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uf6c337b7dc57d24351b192caf612b812":
                    if "join:" in msg.text:
...
#-----------------------------------------------						
            ...
            elif msg.text in ["Tag@@","Tagall","แทค","tagall","tag@@"]:
...
#----------------------ADMIN COMMAND------------------------------#
            ...
            elif "bcf " in msg.text:
                if msg.from_ in admin: 
                    bctxt = msg.text.replace("bcf ", "")
